...
void	ft_stack_size_plus3_b(t_list **l_numbers, t_list **lb_numbers, int h_l, int print);
t_list	*ft_duplicate_list(t_list *l_numbers, t_list *lk_numbers);
void	ft_stack_size_plus3(t_list **l_numbers, t_list **lb_numbers, int h_l, int print);
